 ...
 *  	of the consonants up to the first vowel, move that 
 *  	set of consonants to the end of the word, and add
 *  	"ay".
 ...
 *  characters unchanged. The variable starts keeps track of the index 
 *  position at which the current word begins. As a special case, the code
 *  sets start to -1 to indicated that the beginning of hte current word
 ...
 * ------------------------------------------------
 *  Translate a word from English to Pig Latin using the rules specified in the 
 *  text. The translated word is returned as the value of the function.
 */
 ...
 * -------------------------------------
 *  Returns the index position of the first vowel in word. If word does not
 *  contain a vowel, findFirstVowel returns -1.
 */
int findFirstVowel(string word) {
