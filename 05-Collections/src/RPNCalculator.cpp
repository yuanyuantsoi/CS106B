 ...
 *  apply. Information for users of this application appears in the helpCommand
 *  funtion.
 */
 ...
 * the right is popped before the left operand.
 */
void applyOperator(char op, Stack<double> & operandStack) {
	double result;
...
void helpCommand() {
	...
	cout << "operator, or one of ht following commands: " << endl;
