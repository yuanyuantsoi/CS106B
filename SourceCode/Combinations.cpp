 ...
 * ----------------------
 *  This program computes the mathmaatical function C(n,k) from 
 *  its mathmatical defination in terms of factorials.
 */
 ...
 * --------------------------------------
 * Returns the mathmatical combinations function C(n, k), which is
