 ...
 *  by diaplaying three different constants (pi, the speed of light in meters/second,
 *  and the fine-structure constant). These constants are chosen because they 
 *  illustrate a range of exponent sscales.
 */
...
const double SPEED_OF_LIGHT = 2.9979292458E+8;
